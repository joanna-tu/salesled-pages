...
The open-source research method behind [xray.joannatu.com](https://xray.joannatu.com): one page you hand to your AI, and it builds a full pre-meeting account profile. Made by Joanna Turczynska.
...
The maintained private system this method comes from: exact search queries and weights, account memory, scheduled scans. A page is frozen text; the method on it is complete, the machinery around it is not text.

## License

[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). Use it, share it, adapt it, build on it, commercially too. The one condition is attribution: keep the line "Built on Account X-ray by Joanna Turczynska" on anything built from it.

Method updates land first at [salesled.substack.com](https://salesled.substack.com).
